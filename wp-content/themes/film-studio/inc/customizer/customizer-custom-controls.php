...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Film_Studio_Image_Radio_Control extends WP_Customize_Control {
	    ...
	    public function render_content() {
	        ...
	        <ul class="controls" id='film-studio-custom-container'>
	            <?php
	            // Loop through choices and render radio buttons with images
	            foreach ($this->choices as $value => $label) :
	                // Determine the selected class based on current value
	                $class = ($this->value() == $value) ? 'film-studio-selected-img film-studio-selector-img ' : 'film-studio-selector-img';
	                ?>
